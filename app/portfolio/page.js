      ...
      <section className="portfolio-projects-section section max-w-full mb-52">
        ...
        <div className="flex gap-24">
          ...
          <div className="flex flex-col min-w-[40%]">
            <h2 className="heading mb-10">JOBENY <span className="text-[50px]">RESOURCES</span></h2>
            <p className="mb-12">Lorem ipsum dolor sit amet consectetur. Ut sem mattis condimentum risus risus scelerisque leo. Nibh nec euismod sem pretium. Lorem ipsum dolor sit amet consectetur. Lorem ipsum dolor sit amet consectetur. Ut sem mattis condimentum risus risus scelerisque leo.</p>
            <div className="flex">
