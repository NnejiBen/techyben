      ...
      <section className="home-portfolio-section px-[7.5rem] flex gap-20 mb-32 sm:hidden">
        ...
        <div className="flex flex-col gap-20">
          ...
          <div className="portfolio--text">
            ...
            <p className="text-2xl lg:text-xl text-[#F9F8F8]">I build beautiful and user-friendly websites using the latest frontend development technologies, such as React, Next.js, and WordPress. I'm always up for a challenge, and I love working on new and innovative projects.</p>
          </div>
