      ...
      <section className="flex flex-col">
        ...
        <div className="px-[7.5rem] lg:px-[4rem] md:px-[1.25rem]">
          ...
          <div className="flex justify-end mb-6">
            <p className="text-right sm:text-left text-[1.5rem] sm:text-lg text-[#F1F1F1] font-normal w-3/5 sm:w-full">
             Hi 👋, I'm Ben, a Frontend Web Developer. My passion is to craft websites that reach new heights, fueled by my love for learning 📚 and airplanes ✈️
            </p>
          </div>
