    ...
    <footer className="flex sm:flex-col justify-between items-center bg-[#020617] px-[7.5rem] lg:px-[4em] md:px-[1.25em] py-8">
        <div className="sm:flex flex-col items-center sm:mb-10">
            ...
            <div className="text-[#EAEAEA] text-sm">
                <p>Designed by <Link href="https://www.hijoygirl.com/" target="_blank" title="Visit portfolio" className="hover:text-[#FB8500] underline decoration-solid">Joygirl</Link></p>
            </div>
        </div>
