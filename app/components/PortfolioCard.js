  ...
  return (
    <>
      <div className="relative bg-[#C0D6DF] rounded-3xl">
        ...
        {/* Button */}
        <div className='flex items-center justify-end absolute bottom-0 w-full rounded-b-3xl bg-[#00162B] bg-opacity-50 text-white hover:text-[#FB8500] text-lg md:text-base font-medium px-8 py-3'>
