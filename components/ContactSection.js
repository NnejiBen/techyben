    ...
    <div className="px-[7.5rem] lg:px-[4rem] md:px-[2rem] flex sm:flex-col items-center justify-between">
        ...
        <div className="bg-[#C0D6DF] rounded-3xl flex flex-col h-min sm:w-full">
            ...
            <div className="flex flex-col gap-4 px-5 py-8">
                <Link href="mailto:nnejiben@gmail.com" target="_blank" title="Email me" className="bg-transparent text-[#00162B] hover:text-[#FB8500] text-[1.125rem] font-medium py-3 px-14 md:px-6 border-[1px] sm:px-14 border-[#FB8500] rounded-3xl">nnejiben@gmail.com</Link>
                <Link href="tel:+2348063062992" target="_blank" title="Call me" className="bg-transparent text-[#00162B] hover:text-[#FB8500] text-[1.125rem] font-medium py-3 px-14 md:px-6 border-[1px] sm:px-14 border-[#FB8500] rounded-3xl">234-806-306-2992</Link>
            </div>
        </div>
    </div>
  )
