...
const MobileNavMenu = () => {
  return (
    <>
        <nav className="opacity-0 flex flex-col justify-between fixed top-0 left-0 w-full h-full bg-[#00162B] text-white px-[1.25rem] pt-32">
            <div>
                <div className='mobile-menu-item border-b-[1px] border-[#EAEAEA] py-8 text-xl text-center'><Link href="/">HOME</Link></div>
                <div className='mobile-menu-item border-b-[1px] border-[#EAEAEA] py-8 text-xl text-center'><Link href="/about">ABOUT</Link></div>
                <div className='mobile-menu-item border-b-[1px] border-[#EAEAEA] py-8 text-xl text-center'><Link href="/portfolio">PORTFOLIO</Link></div>
                <div className='mobile-menu-item border-b-[1px] border-[#EAEAEA] py-8 text-xl text-center'><Link href="/contact">CONTACT</Link></div>
            </div>
            {/* Contact icons */}
